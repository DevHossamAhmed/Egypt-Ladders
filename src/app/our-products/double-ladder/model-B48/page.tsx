...
const Plt = () => {
  return (
    <div className="mt-36 px-4">
      <Container>
        <h1 className="my-8 text-secondary text-[14px] md:text-[20px] font-bold">سلم الومنيوم مزدوج درج  عريض من الجانبين   </h1>
        <Image src={modelB48} alt="plt"  className="m-auto xl:m-0"/>
        <div className="flex flex-col xl:flex-row justify-between my-9">
          <ul className="w-full list-disc ml-4 text-[14px] md:text-[18px] font-medium ">
            <li>سلم الومنيوم درج عريض من الجانبين</li>
            <li>يمكن الاستخدام من الجانبين</li>
            ...
            <table className="w-full text-[14px] md:text-[18px] text-center font-medium border-collapse border-2 border-black">
              ...
              <tbody>
                <tr className="even:bg-gray-100">
                  ...
                  <td className="border-2 border-black p-2">B48-02</td>
                </tr>
                <tr className="even:bg-gray-100">
                  ...
                  <td className="border-2 border-black p-2">B48-03</td>
                </tr>
                <tr className="even:bg-gray-100">
                  ...
                  <td className="border-2 border-black p-2">B48-04</td>
                </tr>
                <tr className="even:bg-gray-100">
                  ...
                  <td className="border-2 border-black p-2">B48-05</td>
                </tr>
                <tr className="even:bg-gray-100">
                  ...
                  <td className="border-2 border-black p-2">B48-06</td>
                </tr>
                <tr className="even:bg-gray-100">
                  ...
                  <td className="border-2 border-black p-2">B48-07</td>
                </tr>
